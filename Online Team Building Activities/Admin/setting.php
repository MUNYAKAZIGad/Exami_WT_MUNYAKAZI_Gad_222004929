...
<body>
    <div id="root">
        ...
        <h1 style="text-align: center;margin-bottom: 100px;margin-top:20px;color:#595959">General Setting</h1>
        <div class="MuiBox-root jss144 jss139">
            <div class="MuiContainer-root MuiContainer-maxWidthLg" style="max-width: 750px;">
                <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-5">
                    <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                        <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-4">
                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                <div class="MuiBox-root jss96" style="display: flex; flex-wrap: wrap;">
                                    <div class="MuiBox-root jss97" style="border-color: rgb(102, 130, 251); padding-bottom: 5px;">
                                        <h5 class="MuiTypography-root MuiTypography-h5">General</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                <div class="MuiFormControl-root MuiTextField-root MuiFormControl-fullWidth">
                                    <label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink MuiInputLabel-outlined MuiFormLabel-filled" data-shrink="true">
                                        Platform Name
                                    </label>
                                    <div class="MuiInputBase-root MuiOutlinedInput-root MuiInputBase-fullWidth MuiInputBase-formControl">
                                        <input aria-invalid="false" type="text" class="MuiInputBase-input MuiOutlinedInput-input" value="Team Activities" fdprocessedid="cee06p">
                                        <fieldset aria-hidden="true" class="jss98 MuiOutlinedInput-notchedOutline">
                                            <legend class="jss100 jss101">
                    ...
                    <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                        <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-4">
                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                <div class="MuiBox-root jss102" style="display: flex; flex-wrap: wrap;">
                                    <div class="MuiBox-root jss103" style="border-color: rgb(102, 130, 251); padding-bottom: 5px;">
                                        <h5 class="MuiTypography-root MuiTypography-h5">Delete user from our System</h5>
                                    </div>
                                </div>
                            </div>
                          <div class="MuiGrid-root jss94 MuiGrid-item MuiGrid-grid-xs-12">
                              <!--Start of Form or Body of the website-->
                              <center>
                                  <form action="delete.php" method="post">
                                    <tr>
                                      <td><label>ID Number: &nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" name="delete_stu_id" placeholder="ID Number" required></td>
                                      <td><button type="submit" class="btn" name="stud_delete_btn" value="Login">Delete</button></td>
                                    </tr>
                                  </form>
                              </center>
                            </div>
                    ...
                    <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                        <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-4">
                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12">
                                <div class="MuiBox-root jss102" style="display: flex; flex-wrap: wrap;">
                                    <div class="MuiBox-root jss103" style="border-color: rgb(102, 130, 251); padding-bottom: 5px;">
                                        <h5 class="MuiTypography-root MuiTypography-h5">Change User Password</h5>
                                    </div>
                                </div>
                            </div>
                          <div class="MuiGrid-root jss94 MuiGrid-item MuiGrid-grid-xs-12">
                              ...
                              <center>
                                  <form action="update.php" method="post">
                                    <tr>
                                      <td><label>Your Account id: &nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" name="id" placeholder="Account ID " required></td>
                                    </tr></br>
                                    <tr>
                                      <td><label>New Password: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="password" name="changepwd" placeholder="New Password" required></td>
                                    </tr></br></br>
                                    <tr>
                                      <td><button type="submit" class="btn" name="stud_changepwd_btn" value="Login">Change</button></td>
                                    </tr></br>
                                  </form>
                              </center>
                            </div>
