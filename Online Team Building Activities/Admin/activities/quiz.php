...
<body>
    <div id="root">
        ...
        <!--Start of side bar -->
            <ul class="MuiList-root MuiList-padding" id="pointer">
                <!--Added List-->
        ...
        <div class="MuiBox-root jss144 jss139">
          <div class="activities" id="Pricing" >
            ...
            <div class="Grant_parent_block">
                <div style="font-weight: bolder;font-size: 30px;text-align: center;color:#595959">
                   <h1>Welcome to Quiz Activity</h1>
                   <p>
                      This Activity will ask you question and you have to answer of them in order to test You
                      your knowledge about public skills
                   </p>
                <center>
                   <form action="quizQ.php" Method="POST">
                      <table>
                        <tr>
                            <td><lable>what is Capital city of Rwanda? </lable></td>
                            <td><input type="text" name="one"></td>
                        </tr>
                        <tr>
                            <td><lable>How many district does Rwanda Have? </lable></td>
                            <td><input type="text" name="two"></td>
                        </tr>
                        <tr>
                            <td><lable>Does Rwanda located in Easter Africa? </lable></td>
                            <td><input type="text" name="three"></td>
                        </tr>
                        <tr>
                            <td><lable>Who is President of Rwanda? </lable></td>
