        ...
        <div class="MuiBox-root jss144 jss139">
          <div class="activities" id="Pricing" >
            ...
            <div class="Grant_parent_block">
                <div style="font-weight: bolder;font-size: 30px;text-align: center;margin-bottom: 100px;margin-top:20px;color:#595959">
                   <h1>Welcome to Tombola Activity</h1>
                   <form action="guess.php" Method="POST">
                      <tr><td>Hello user Friend, you are going to guess hidden number. And guess is between range of 1 up 10! Let's Try.</td></tr>
                      <tr></br></br></br>
                        <td><lable>Tombola: </lable></td>
                        <td><input type="text" name="guess"></td>
                      </tr>
                      <tr><input type="submit" value="Spin"></tr>
                   </form>
                </div>
            </div>
        </div>
